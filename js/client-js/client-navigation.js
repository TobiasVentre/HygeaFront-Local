...
import { applyStylesForSection } from './client-ui.js';
...
export async function handleSectionNavigation(section) {
    ...
    switch(section) {
        case 'inicio':
            ...
            const { loadClientAppointments } = await import('./client-appointments.js');
            const { loadRecentClientHistory } = await import('./client-history-recent.js');
        ...
        case 'turnos':
            ...
            const { loadClientAppointments: loadAppointmentsFull } = await import('./client-appointments.js');
        ...
        case 'historial':
            ...
            const { loadClientHistoryFull } = await import('./client-history.js');
            await loadClientHistoryFull();
            ...
            if (!prescriptionsFullSection) {
                ...
                prescriptionsFullSection.innerHTML = `
                    <div class="section-header">
                        <div>
                            <h3>Mis Recetas </h3>
                            <p>Todas tus recetas y prescripciones </p>
                        </div>
                ...
                setTimeout(() => {
                    ...
                    if (refreshBtn) {
                        refreshBtn.addEventListener('click', async () => {
                            const { loadClientPrescriptions } = await import('./client-prescriptions-list.js');
                            await loadClientPrescriptions();
                        });
                    }
                }, 100);
            } else {
